...
public class StudentController {
    ...
    @Operation(summary = "Mettre à jour un étudiant", description = "Mettre à jour les informations d'un étudiant")
    @ApiResponse(responseCode = "200", description = "Étudiant mis à jour avec succès")
    @ApiResponse(responseCode = "404", description = "Étudiant non trouvé")
    public ResponseEntity<?> update(@PathVariable UUID trackingId, @RequestBody StudentRequest request) {
        try {
