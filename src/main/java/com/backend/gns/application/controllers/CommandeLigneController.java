...
public class CommandeLigneController {
    ...
    @PostMapping
    @Operation(summary = "Créer une ligne de commande", description = "Crée une nouvelle ligne de commande")
    ...
    @Operation(summary = "Récupérer une ligne de commande", description = "Récupère une ligne de commande par son ID")
    ...
    public ResponseEntity<?> findByTrackingId(@PathVariable UUID trackingId) {
        try {
            return commandeLigneService.findByTrackingId(trackingId)
    ...
    @Operation(summary = "Mettre à jour une ligne de commande", description = "Mettre à jour les informations d'une ligne de commande")
    @ApiResponse(responseCode = "200", description = "Ligne de commande mise à jour avec succès")
    @ApiResponse(responseCode = "404", description = "Ligne de commande non trouvée")
    public ResponseEntity<?> update(@PathVariable UUID trackingId, @RequestBody CommandeLigneRequest request) {
        try {
    ...
    @Operation(summary = "Supprimer une ligne de commande", description = "Supprime une ligne de commande par son ID")
