...
public class SecurityExceptionsHandler {
  ...
  private static final String ACCOUNT_LOCKED =
      "Votre compte a été bloqué. Veuillez contacter l'administration";
  ...
  private static final String ACCOUNT_DISABLED =
      "Votre compte a été désactivé. S'il s'agit d'une erreur, veuillez contacter l'administration";
  ...
  /**
   * Gère l'exception de compte bloqué. Statut HTTP 403 (Forbidden) est plus précis que 401 pour un
   * compte connu mais restreint.
   */
  ...
  public ResponseEntity<HttpErrorResponse> noHandlerFoundException(
  ...
  public ResponseEntity<HttpErrorResponse> methodArgumentNotValidException(
  ...
  public ResponseEntity<HttpErrorResponse> userAlreadyExistException(
  ...
  public ResponseEntity<HttpErrorResponse> constraintViolationException(
  ...
  public ResponseEntity<HttpErrorResponse> httpMediaTypeNotSupportedException(
  ...
  /**
   * Gestionnaire catch-all pour toutes les autres exceptions non gérées. Retourne 500 Internal
   * Server Error.
   */
  ...
  public ResponseEntity<HttpErrorResponse> handleDataIntegrityViolation(
      DataIntegrityViolationException exception) {
    String message = exception.getMessage().toLowerCase();
    if (message.contains("unique")
        && (message.contains("email") || message.contains("user_email"))) {
      return createHttpResponse(
          BAD_REQUEST, "L'email que vous avez fourni est déjà utilisé par un autre compte.");
    }
    return createHttpResponse(
        BAD_REQUEST,
        "Une erreur d'intégrité des données s'est produite. Veuillez vérifier les informations.");
  }
