...
import com.backend.gns.student.application.mappers.ParametreDbsMapper;
...
public class ParametreDbsServiceImpl implements ParametreDbsService {
  ...
  public ParametreDbsResponse saveOrUpdate(ParametreDbsRequest request) {
    ParametreDbs parametre =
        repository.findByNomParametre(request.nomParametre()).orElse(new ParametreDbs());
