...
/**
 * Orchestrateur pour le cycle de vie de l'étudiant. Gère les transitions complexes entre
 * inscription, éligibilité et activation du portefeuille.
 */
public interface StudentWorkflowService {

  /**
   * Valide une inscription annuelle et déclenche le calcul d'éligibilité à la bourse. Si éligible,
   * le portefeuille de l'étudiant est activé avec le plafond correspondant.
   *
