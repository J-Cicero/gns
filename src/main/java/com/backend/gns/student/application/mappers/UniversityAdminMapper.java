...
public class UniversityAdminMapper {
  ...
  public UniversityAdmin toEntity(UniversityAdminRequest request) {
    if (request == null) {
      throw new IllegalArgumentException(
          "La requête UniversityAdminRequest ne peut pas être nulle");
    }
  ...
  public UniversityAdminResponse toResponse(UniversityAdmin universityAdmin) {
    ...
    return UniversityAdminResponse.builder()
        ...
        .walletTrackingId(
            universityAdmin.getWallet() != null
                ? universityAdmin.getWallet().getTrackingId()
                : null)
        .universiteTrackingId(
            universityAdmin.getUniversite() != null
                ? universityAdmin.getUniversite().getTrackingId()
                : null)
        .build();
  }
}
