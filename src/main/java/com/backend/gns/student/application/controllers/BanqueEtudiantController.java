...
public class BanqueEtudiantController {
  ...
  @PostMapping
  @Operation(
      summary = "Créer une information bancaire",
      description = "Crée une nouvelle information bancaire pour un étudiant")
  ...
  @Operation(
      summary = "Récupérer une information bancaire",
      description = "Récupère une information bancaire par son ID")
  ...
  @Operation(
      summary = "Mettre à jour une information bancaire",
      description = "Mettre à jour les informations d'une information bancaire")
  @ApiResponse(responseCode = "200", description = "Information bancaire mise à jour avec succès")
  @ApiResponse(responseCode = "404", description = "Information bancaire non trouvée")
  public ResponseEntity<BanqueEtudiantResponse> update(
      @PathVariable UUID trackingId, @RequestBody BanqueEtudiantRequest request) {
  ...
  @Operation(
      summary = "Supprimer une information bancaire",
      description = "Supprime une information bancaire par son ID")
  ...
  @GetMapping
  @Operation(
      summary = "Récupérer toutes les informations bancaires",
      description = "Récupère la liste de toutes les informations bancaires")
  ...
  @Operation(
      summary = "Récupérer les informations bancaires d'un étudiant",
      description = "Récupère les informations bancaires d'un étudiant spécifique")
  @ApiResponse(responseCode = "200", description = "Informations bancaires trouvées")
  public ResponseEntity<Page<BanqueEtudiantResponse>> findByStudentTrackingId(
      @PathVariable UUID studentTrackingId, Pageable pageable) {
    Page<BanqueEtudiantResponse> responses =
        banqueEtudiantService.findByStudentTrackingId(studentTrackingId, pageable);
    return ResponseEntity.ok(responses);
  }
}
