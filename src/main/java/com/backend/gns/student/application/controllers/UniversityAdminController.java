...
public class UniversityAdminController {
  ...
  @PostMapping
  @Operation(
      summary = "Créer un administrateur UL",
      description = "Crée un nouvel administrateur UL")
  @ApiResponse(responseCode = "201", description = "Administrateur UL créé avec succès")
  public ResponseEntity<UniversityAdminResponse> create(
      @RequestBody UniversityAdminRequest request) {
  ...
  @Operation(
      summary = "Récupérer un administrateur UL",
      description = "Récupère un administrateur UL par son ID")
  ...
  @Operation(
      summary = "Mettre à jour un administrateur UL",
      description = "Mettre à jour les informations d'un administrateur UL")
  @ApiResponse(responseCode = "200", description = "Administrateur UL mis à jour avec succès")
  @ApiResponse(responseCode = "404", description = "Administrateur UL non trouvé")
  public ResponseEntity<UniversityAdminResponse> update(
      @PathVariable UUID trackingId, @RequestBody UniversityAdminRequest request) {
  ...
  @Operation(
      summary = "Supprimer un administrateur UL",
      description = "Supprime un administrateur UL par son ID")
  ...
  @GetMapping
  @Operation(
      summary = "Récupérer tous les administrateurs UL",
      description = "Récupère la liste de tous les administrateurs UL")
  ...
  public ResponseEntity<Page<UniversityAdminResponse>> findByUniversite(
      @PathVariable UUID universiteTrackingId, Pageable pageable) {
    return ResponseEntity.ok(
        universityAdminService.findByUniversiteTrackingId(universiteTrackingId, pageable));
  }
}
