...
public class PretScolariteServiceImpl implements PretScolariteService {
  ...
  @Override
  @Transactional
  public PretScolariteResponse demanderPretScolarite(
    ...
    log.info(
        "Prêt scolarité créé pour l'étudiant {} d'un montant de {}", student.getNom(), montant);
  ...
  public void rembourserPretsEnAttente(UUID studentTrackingId, BigDecimal montantDisponible) {
    List<PretScolarite> pretsNonRembourses =
        pretScolariteRepository.findByStudentTrackingIdAndEstRembourseFalse(studentTrackingId);
