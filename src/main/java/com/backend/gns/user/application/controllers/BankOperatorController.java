...
import com.backend.gns.user.domain.services.BankOperatorService;
...
public class BankOperatorController {
  ...
  @PostMapping
  @Operation(
      summary = "Créer un opérateur bancaire",
      description = "Crée un nouvel opérateur bancaire")
  ...
  @Operation(
      summary = "Récupérer un opérateur bancaire",
      description = "Récupère un opérateur bancaire par son ID")
  ...
  @Operation(
      summary = "Mettre à jour un opérateur bancaire",
      description = "Mettre à jour les informations d'un opérateur bancaire")
  @ApiResponse(responseCode = "200", description = "Opérateur bancaire mis à jour avec succès")
  @ApiResponse(responseCode = "404", description = "Opérateur bancaire non trouvé")
  public ResponseEntity<BankOperatorResponse> update(
      @PathVariable UUID trackingId, @RequestBody BankOperatorRequest request) {
  ...
  @Operation(
      summary = "Supprimer un opérateur bancaire",
      description = "Supprime un opérateur bancaire par son ID")
  ...
  @GetMapping
  @Operation(
      summary = "Récupérer tous les opérateurs bancaires",
      description = "Récupère la liste de tous les opérateurs bancaires")
